...
$current_file = 'dokter_list.php'; // Highlight menu
    ...
    if ($result && mysqli_num_rows($result) == 1) {
        ...
        if ($dokter_data['admin_id']) {
            ...
            if ($row_current = mysqli_fetch_assoc($res_current)) {
                // Cek duplikasi agar tidak double di dropdown
                $is_exist = false;
...
<head>
    ...
    <title><?php echo $mode; ?> Dokter | Super Admin</title>
    ...
    <div id="page-content-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h3 class="fw-bold text-dark mb-1"><?php echo $mode; ?> Data Dokter</h3>
                    <p class="text-muted small mb-0">Formulir kelola data dokter dan spesialisasi.</p>
                </div>
                <a href="dokter_list.php" class="btn btn-outline-secondary btn-sm d-flex align-items-center">
            ...
            <div class="card card-custom">
                <div class="card-header-custom">
                    <h5 class="fw-bold text-primary mb-0"><i class="bi bi-person-vcard me-2"></i>Informasi Dokter</h5>
                </div>
                <div class="card-body p-4">
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                        ...
                        <div class="mb-4">
                            <label for="admin_id" class="form-label fw-bold small">User Akun (Link ke Login)</label>
                            ...
                            <div class="form-text small">Hanya akun role 'Dokter' yang belum dipakai.</div>
                        </div>

                        <div class="row g-3">
                            <div class="col-12">
                                <label for="nama_lengkap" class="form-label fw-bold small">Nama Lengkap & Gelar <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?php echo htmlspecialchars($dokter_data['nama_lengkap'] ?? ''); ?>" required placeholder="Cth: Dr. Siti Aminah, Sp.KJ">
                            </div>

                            <div class="col-12 col-md-6">
                                <label for="spesialisasi" class="form-label fw-bold small">Spesialisasi <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12 col-md-6">
                                <label for="no_str" class="form-label fw-bold small">Nomor STR</label>
                                <input type="text" class="form-control" id="no_str" name="no_str" value="<?php echo htmlspecialchars($dokter_data['no_str'] ?? ''); ?>" placeholder="Surat Tanda Registrasi">
                            </div>

                            <div class="col-12 col-md-6">
                                <label for="no_telepon" class="form-label fw-bold small">No. Telepon / Kontak</label>
                            ...
                            <div class="col-12 col-md-6 d-flex align-items-end">
                                <div class="form-check form-switch mb-2">
                                    <input class="form-check-input" type="checkbox" id="status_aktif" name="status_aktif" value="1" <?php echo ($dokter_data['status_aktif'] ?? 1) == 1 ? 'checked' : ''; ?>>
                                    <label class="form-check-label fw-bold" for="status_aktif">Status Aktif Praktik</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="dokter_list.php" class="btn btn-light border fw-bold py-2 px-4 order-2 order-md-1">Batal</a>
