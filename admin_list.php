        ...
        <div class="main-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted small mb-0">Kelola akun admin, dokter, dan staff.</p>
                </div>
                <a href="admin_form.php" class="btn btn-primary shadow-sm fw-bold btn-sm-mobile" style="background-color: var(--primary-highlight); border-color: var(--primary-highlight);">
            ...
            <div class="card card-custom">
                <div class="card-header-custom">
                    <h6 class="fw-bold text-primary mb-0"><i class="bi bi-people-fill me-2"></i>Daftar Pengguna</h6>
                ...
                <div class="card-body p-0">
                                ...
                                <tbody>
                                    <?php while($row = mysqli_fetch_assoc($result)): ?>
                                        <?php 
                                            ...
                                            if($row['role'] == 'Super Admin') $role_color = 'danger';
                                            elseif($row['role'] == 'Dokter') $role_color = 'info text-dark';
                                            elseif($row['role'] == 'Front Office') $role_color = 'success';
                                        ?>
                                        <tr>
                                            <td class="ps-4 fw-bold text-muted">#<?php echo $row['admin_id']; ?></td>
                                            <td class="fw-bold text-dark"><?php echo htmlspecialchars($row['username']); ?></td>
                                            <td><?php echo htmlspecialchars($row['nama_lengkap']); ?></td>
                                            <td><span class="badge bg-<?php echo $role_color; ?>"><?php echo $row['role']; ?></span></td>
                                            <td><?php echo $status_badge; ?></td>
                                            <td class="text-center pe-4">
                                                <div class="btn-group btn-group-sm">
                                                    <a href="admin_form.php?id=<?php echo $row['admin_id']; ?>" class="btn btn-outline-warning text-dark" title="Edit">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                    <a href="admin_delete.php?id=<?php echo $row['admin_id']; ?>" onclick="return confirm('Hapus akun <?php echo htmlspecialchars($row['username']); ?>?')" class="btn btn-outline-danger" title="Hapus">
                    ...
                    <?php else: ?>
                        <div class="p-5 text-center">
                            <i class="bi bi-person-x display-4 text-muted opacity-50"></i>
                            <p class="mt-3 text-muted small fw-bold">Belum ada data admin.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
